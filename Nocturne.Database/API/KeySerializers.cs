...
public sealed class KeySerializers
{
    ...
    internal class InlineKeySerializer<T>(Action<IByteBuffer, T> read, Func<IByteBuffer, T> write, Func<T, T, bool> compare) : NocturneKeySerializer<T>
    {
        ...
        protected override bool CompareValues(T left, T right) => compare.Invoke(left, right);
    }
}
